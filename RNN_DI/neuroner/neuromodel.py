...
from neuroner.entity_GRU import EntityLSTM
...
def _get_default_param():
    ...
    """
    param = {
        'pretrained_model_folder': '/dspSharedData/Dernoncourt-original/neuroner/trained_models/i2b2_2014_glove_stanford_bioes',
        # 'dataset_text_folder':'/dspSharedData/Dernoncourt-original/neuroner/data/conll2003/en',
        'dataset_text_folder': '/dspSharedData/Dernoncourt-original/neuroner/data/i2b2',
        ...
        'token_pretrained_embedding_filepath': '/dspSharedData/Dernoncourt-original/neuroner/data/word_vectors/glove.6B.100d.txt',
        'tokenizer': 'spacy',
        'train_model': True,
        ...
        try:
            while True:
                ...
                print('Training completed in {0:.2f} seconds'.format(epoch_elapsed_training_time),
                      flush=True)
                if (epoch_number != 0) and (epoch_number % evaluation_epoch_number) == 0:
                    ...
                    evaluate.evaluate_model(results, modeldata, y_pred, y_true, stats_graph_folder, epoch_number,
