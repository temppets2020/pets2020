    ...
    def model_fn(features, labels, mode, params):
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            if FLAGS.penalty:
                ...
                cmetrics = metrics.streaming_confusion_matrix_with_current_cm(label_ids, predictions, num_labels, weights=mask)
                # total_cm = cmetrics[0]
